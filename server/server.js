...
const { sendNotificationList, sendHeartbeatList, sendDowntimeStats, sendImportantHeartbeatList, sendInfo, sendProxyList, sendDockerHostList, sendAPIKeyList } = require("./client");
    ...
    io.on("connection", async (socket) => {
        ...
        socket.on("requestDownTimeStats", async (start_time, end_time, callback) => {
            try {
                ...
                callback({
                    ok: true,
                    msg: "Downtime stats sent successfully."
                });
